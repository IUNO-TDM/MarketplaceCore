...
-- 	1) Why is this Patch necessary? 
--	The component list is not showing at "Rezepte Verwalten" as it should be.
-- 	2) Which Git Issue Number is this patch solving? 
--	#131
-- 	3) Which changes are going to be done? 
--	Update GetTechnologyDataByParams. Set ComponentsWithAttribute to ComponentsList
--: Run Patches
------------------------------------------------------------------------------------------------
--##############################################################################################
...
$$
	DECLARE
		PatchName varchar		 	 := 'iuno_marketplacecore_V0011V_20171122';
		PatchNumber int 		 	 := 0011;
		PatchDescription varchar 	 := 'Update GetTEchnologyDataByParams. Set ComponentsWithAttribute to ComponentsList';
